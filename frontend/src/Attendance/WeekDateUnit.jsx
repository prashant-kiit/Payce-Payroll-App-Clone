...
function WeekDateUnit({
  ...
  function isLockButtonDisabled(
    ...
    console.log(
      (!!attendanceDatesLockedSessionHistory[weekDate] &&
        !!isLockSessionHistoryButtonDisabled) ||
        !!previousSessionAttendanceData[weekDate]
    );
    return (
      (!!attendanceDatesLockedSessionHistory[weekDate] &&
        !!isLockSessionHistoryButtonDisabled) ||
  ...
  return (
    <div key={"keyDiv" + weekDate}>
      ...
      <label key={"keyLabelHours" + weekDate} htmlFor={"labelHours" + weekDate}>
        Work-Hours
      </label>{" "}
      <input
        ...
        } // isAttendanceLocked = (undefined) or true or false
        onChange={async (e) => {
      ...
      <button
        ...
        onClick={async () => {
          ...
          console.log(
            "Attendance Dates Locked List [weekDate] = " +
              attendanceDatesLockedList[weekDate]
          );
          console.log(
            "Cond 1 = " + !(workHours ?? attendanceDatesLockedList[weekDate])
          );
          console.log(
            "Cond 2 = " +
              !(isAttendanceLocked ?? attendanceDatesLockedList[weekDate])
          );
          console.log(
            "Cond 3 = " +
              !!(isAttendanceLocked ?? attendanceDatesLockedList[weekDate])
